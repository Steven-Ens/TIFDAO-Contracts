...
// BalanceScanner.sol was created by the authors below, and it is available at: https://github.com/MyCryptoHQ/eth-scan
// The only difference between this and the official version is adding ^ so as to use a higher compiler version
